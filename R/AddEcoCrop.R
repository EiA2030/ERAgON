...
AddEcoCrop<-function(Products){
  ...
  E.Names<-data.table(ERAg::EUCodes)[match(Products,Product),ECOCROP.Name]

  E.Data<-ERAgON::ERA_EcoCrop[match(E.Names,species),c("species","temp_opt_min","Temp_Opt_Max","Temp_Abs_Min","Temp_Abs_Max","cycle_min","cycle_max")]
